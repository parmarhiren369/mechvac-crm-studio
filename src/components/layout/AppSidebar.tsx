...
const settingsItems: MenuItem[] = [
  ...
  { title: "Workspaces", icon: Briefcase, path: "/workspaces" },
  {
    ...
    icon: Users,
    children: [
      { title: "Status", path: "/settings/leads/status" },
    ],
  },
  {
    title: "Fields",
    icon: FileText,
    children: [
      { title: "Position/Designation", path: "/settings/fields/positions" },
      { title: "Department", path: "/settings/fields/departments" },
      { title: "Industries", path: "/settings/fields/industries" },
      { title: "Pump Type", path: "/settings/fields/pump-types" },
      { title: "Manufacturer (OEM)", path: "/settings/fields/manufacturers" },
      { title: "Units", path: "/settings/fields/units" },
      { title: "Pump Model Details", path: "/settings/fields/pump-models" },
    ],
  },
  { title: "Inspection Report Fields", icon: CheckSquare, path: "/settings/inspection" },
  {
    ...
    icon: Globe,
    children: [
      { title: "Countries", path: "/settings/localization/countries" },
      { title: "States", path: "/settings/localization/states" },
      { title: "Cities", path: "/settings/localization/cities" },
    ],
  },
];
