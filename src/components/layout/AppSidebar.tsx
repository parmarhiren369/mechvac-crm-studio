...
const settingsItems: MenuItem[] = [
  ...
  },
  {
    ...
    icon: FileText,
    children: [
      { title: "Position/Designation", path: "/settings/fields/position" },
      { title: "Department", path: "/settings/fields/department" },
      { title: "Industries", path: "/settings/fields/industry" },
      { title: "Pump Type", path: "/settings/fields/pump-type" },
      { title: "Manufacturer (OEM)", path: "/settings/fields/manufacturer" },
      { title: "Units", path: "/settings/fields/units" },
      { title: "Pump Model Details", path: "/settings/fields/pump-model" },
    ],
  },
